...
declare -A packages
packages[dev_tools]="openjdk-21-jdk gcc g++ clang ninja-build cmake shellcheck build-essentials gdb iwyu cpplint"
packages[utilities]="tealdeer unzip eza bat jq ripgrep fzf xeyes mesa-utils htop btop screen dos2unix fd-find"
...
# This file was generated by dotfiles/scripts/dotfiles/install.sh
